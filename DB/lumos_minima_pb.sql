...
INSERT INTO `area_illuminata` (`ID`, `città`, `zona_geografica_città`, `modalità_funzionamento`, `luminosità_standard`, `luminosità_rilevamento`, `luminosità_manuale`, `stato`) VALUES
	(1, 'Padova', 'Via Brofferio', 'M', 2, 3, 2, 0),
	(2, 'Asiago', 'Piazza Carli', 'M', 6, 7, NULL, 0),
...
-- Dump dei dati della tabella lumosminima_pb.guasto: ~10 rows (circa)
...
-- Dump dei dati della tabella lumosminima_pb.lampione: ~85 rows (circa)
INSERT INTO `lampione` (`ID`, `IP`, `tipo_interazione`, `luminosità_default`, `luminosità_impostata`, `id_area_illuminata`, `stato`) VALUES
	...
	(15, '131.228.166.2', 'PUSH', 8, 6, 2, 0),
	(16, '75.114.146.81', 'PUSH', 5, 8, 11, 0),
	...
	(44, '109.86.157.108', 'PUSH', 5, 3, 8, 0),
	(45, '24.184.191.125', 'PUSH', 4, 6, 2, 0),
	(46, '73.107.46.82', 'PUSH', 1, 8, 6, 1),
	(47, '113.73.72.47', 'PUSH', 7, 5, 7, 0),
	(48, '248.67.67.150', 'PUSH', 2, 2, 8, 0),
	(49, '197.96.128.1', 'PUSH', 4, 6, 9, 1),
	(50, '23.82.214.123', 'PUSH', 7, 3, 10, 0),
	(51, '76.54.208.162', 'PUSH', 1, 4, 2, 0),
	(52, '11.204.10.27', 'PUSH', 2, 2, 5, 0),
	(53, '231.241.166.108', 'PUSH', 5, 9, 3, 1),
	(54, '42.198.223.39', 'PUSH', 2, 4, 9, 0),
	(55, '137.232.163.83', 'PUSH', 4, 9, 5, 0),
	(56, '241.208.120.235', 'PUSH', 1, 9, 8, 0),
	...
	(75, '48.63.156.92', 'PUSH', 4, 1, 10, 0),
	(76, '92.105.72.231', 'PUSH', 3, 3, 8, 0),
...
-- Dump dei dati della tabella lumosminima_pb.sensore: ~22 rows (circa)
INSERT INTO `sensore` (`ID`, `IP`, `polling_time`, `zona_geografica_posizionamento`, `tipo_interazione`, `raggio_azione`, `id_area_illuminata`) VALUES
	...
	(2, '1.21.34.56', 35, 'Semaforo Pedonale', 'PUSH', 10, 1),
