...
INSERT INTO `lampione` (`ID`, `IP`, `tipo_interazione`, `luminosità_default`, `luminosità_impostata`, `id_area_illuminata`) VALUES
	(102, '76.59.9.77', 'PUSH', 7, 4, 11),
	(103, '245.189.183.100', 'PUSH', 5, 4, 5),
	(104, '145.133.140.236', 'PUSH', 9, 5, 7),
	(115, '59.177.30.101', 'PUSH', 6, 8, 4),
	(122, '26.109.23.239', 'PUSH', 1, 4, 3),
	(125, '17.47.72.112', 'PUSH', 5, 1, 11),
	(133, '215.67.242.248', 'PUSH', 1, 6, 6),
	(139, '74.50.118.234', 'PUSH', 9, 1, 2),
	(147, '131.228.166.2', 'PUSH', 8, 6, 2),
	(148, '46.8.230.6', 'PUSH', 3, 9, 1),
	(158, '75.114.146.81', 'PUSH', 5, 8, 11),
	(160, '232.199.42.205', 'PUSH', 5, 7, 6),
	(173, '123.122.90.243', 'PUSH', 4, 9, 9),
	(177, '71.151.160.106', 'PUSH', 4, 4, 5),
	(182, '114.241.193.37', 'PUSH', 2, 1, 11),
	(185, '198.62.15.219', 'PUSH', 5, 1, 2),
	(188, '201.210.151.222', 'PUSH', 9, 8, 4),
	(198, '110.177.218.121', 'PUSH', 1, 4, 8),
	(206, '209.119.10.4', 'PUSH', 9, 5, 4),
	(207, '243.12.212.66', 'PUSH', 7, 7, 1),
	(209, '41.207.245.215', 'PUSH', 5, 2, 6),
	(221, '76.190.167.32', 'PUSH', 6, 6, 6),
	(225, '125.235.167.155', 'PUSH', 4, 1, 1),
	(240, '176.211.199.129', 'PUSH', 3, 8, 9),
	(243, '27.194.216.2', 'PUSH', 6, 6, 9),
	(300, '170.137.77.67', 'PUSH', 1, 4, 4),
	(303, '148.124.126.66', 'PUSH', 5, 6, 3),
	(315, '173.209.178.83', 'PUSH', 7, 8, 6),
	(318, '82.189.32.13', 'PUSH', 2, 3, 5),
	(324, '12.230.101.60', 'PUSH', 8, 4, 6),
	(391, '215.245.85.154', 'PUSH', 3, 7, 9),
	(397, '68.74.19.250', 'PUSH', 7, 2, 10),
	(399, '170.227.54.237', 'PUSH', 5, 3, 2),
	(401, '125.49.250.227', 'PUSH', 2, 1, 3),
	(428, '195.59.77.218', 'PUSH', 8, 6, 5),
	(435, '17.206.156.172', 'PUSH', 2, 5, 9),
	(438, '163.203.94.169', 'PUSH', 9, 7, 4),
	(439, '84.12.140.5', 'PUSH', 6, 6, 4),
	(442, '109.86.157.108', 'PUSH', 5, 3, 8),
	(454, '24.184.191.125', 'PUSH', 4, 6, 2),
	(462, '73.107.46.82', 'PUSH', 1, 8, 6),
	(477, '113.73.72.47', 'PUSH', 7, 5, 7),
	(497, '248.67.67.150', 'PUSH', 2, 2, 8),
	(502, '197.96.128.1', 'PUSH', 4, 6, 9),
	(524, '23.82.214.123', 'PUSH', 7, 3, 10),
	(549, '76.54.208.162', 'PUSH', 1, 4, 2),
	(570, '11.204.10.27', 'PUSH', 2, 2, 5),
	(597, '231.241.166.108', 'PUSH', 5, 9, 3),
	(625, '42.198.223.39', 'PUSH', 2, 4, 9),
	(626, '137.232.163.83', 'PUSH', 4, 9, 5),
	(627, '241.208.120.235', 'PUSH', 1, 9, 8),
	(634, '55.95.84.204', 'PUSH', 3, 3, 11),
	(644, '166.93.141.183', 'PUSH', 5, 5, 5),
	(662, '113.236.142.104', 'PUSH', 1, 8, 7),
	(674, '89.210.232.118', 'PUSH', 3, 5, 1),
	(677, '160.171.176.26', 'PUSH', 1, 2, 2),
	(684, '155.181.3.246', 'PUSH', 7, 1, 5),
	(697, '156.73.235.2', 'PUSH', 9, 9, 10),
	(713, '203.233.37.58', 'PUSH', 6, 7, 6),
	(738, '148.25.130.151', 'PUSH', 6, 5, 4),
	(741, '222.173.230.7', 'PUSH', 9, 8, 8),
	(776, '154.229.19.116', 'PUSH', 3, 1, 9),
	(778, '109.77.241.78', 'PUSH', 4, 1, 11),
	(790, '2.182.228.190', 'PUSH', 3, 9, 9),
	(801, '240.18.53.156', 'PUSH', 1, 9, 5),
	(820, '133.231.205.39', 'PUSH', 3, 7, 4),
	(825, '204.167.198.23', 'PUSH', 6, 7, 7),
	(830, '152.114.122.208', 'PUSH', 3, 3, 6),
	(837, '122.209.27.91', 'PUSH', 6, 8, 8),
	(847, '48.63.156.92', 'PUSH', 4, 1, 10),
	(855, '92.105.72.231', 'PUSH', 3, 3, 8),
	(860, '153.154.250.92', 'PUSH', 4, 4, 5),
	(873, '9.163.53.154', 'PUSH', 9, 7, 6),
	(886, '201.238.8.219', 'PUSH', 5, 4, 10),
	(894, '191.218.119.203', 'PUSH', 8, 9, 6),
	(904, '156.137.241.177', 'PUSH', 5, 1, 7),
	(913, '206.16.59.53', 'PUSH', 2, 9, 5),
	(914, '210.6.221.175', 'PUSH', 1, 1, 5),
	(923, '137.123.2.237', 'PUSH', 2, 8, 5),
	(927, '243.140.216.131', 'PUSH', 7, 5, 1),
	(943, '203.196.180.24', 'PUSH', 2, 8, 1),
	(992, '207.63.63.226', 'PUSH', 8, 8, 1);
