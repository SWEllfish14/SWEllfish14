...
import {IAggiungiLampioneViewModel } from "../ViewModel/AggiungiLampioneViewModel";
 ...
 const AggiungiLampioneView = ({viewModel}: Props) => (
  ...
  <div id="lampione-margin" className ="tile-is-ancestor">
  ...
  <label className="login-label" htmlFor="tipo_interazione">Tipo interazione con il lampione</label>
      ...
      <label className="login-label" htmlFor="luminositaDefault">Luminosità standard</label>
                <input
  ...
  <label className="login-label" htmlFor="luminositaDefault">Luminosità Manuale</label>
                <input
  ...
  <label className="login-label" htmlFor="stato">Stato</label>
    ...
    <label className="login-label" htmlFor="area">Id area illuminata afferenza</label>
    <input
                  id="area"
                  name="area"
                  className="input"
