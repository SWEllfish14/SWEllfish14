...
const AreaDetailsView = ({ viewModel }: Props) => (
  <div>
      ...
      <div className="column is-half">
        ...
        {viewModel.areaDetails() && (
          ...
          <div className="box">
            ...
            <p>
            {viewModel.areaDetails().data?.modalità_funzionamento === 'M'?<>Luminosità in modalità manuale: {viewModel.areaDetails().data?.luminosità_manuale}</>
              :<>Luminosità in modalità automatica: {viewModel.areaDetails().data?.luminosità_standard}</>
            }
            </p>
    ...
    <Link to={{pathname: `/aggiungiSensore`}}>
      ...
      <Link to={{pathname: `/lampioni/${viewModel.areaDetails().data?.ID}`}}>
