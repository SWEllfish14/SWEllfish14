...
type LampioniJTO = {IP: string; ID: number;tipo_iterazione:string;luminosita_default: number; luminosita_impostata: number;id_area_illuminata: number };


type SensoriJTO = {ID: string; IP: number; polling_time: number; zona_geografica_posizionamento: string;tipo_iterazione:string;raggio_azione: number; id_area_illuminata: number};
